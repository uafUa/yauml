 ...
 *
 * Qt Installer Framework offline installers cannot update another offline
 * installation directly. Present a single upgrade flow to the user by
 * removing the registered installation through its own maintenance tool and
 * then installing the new package into the same directory.
 */
