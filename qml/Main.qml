...
ApplicationWindow {
    ...
    CatalogDialog {
        ...
        readonly property var contextToolboxActionLabels: ({
            ...
            "connector.routeAroundObstacles": qsTr("Route around obstacles"),
            "connector.optimizeEndsAndRoute": qsTr("Optimize ends and route"),
            ...
            "presentation.routeInternalConnectors": qsTr("Route internal connectors"),
            "presentation.optimizeInternalConnectorEndsAndRoute": qsTr("Optimize internal connector ends and routes"),
